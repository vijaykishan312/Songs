...
import { DurationType, FinishMode, PermissionStatus, PlayerState, RecorderState, UpdateFrequency, } from '../../constants';
...
export const Waveform = forwardRef((props, ref) => {
    const { mode, path, candleSpace = 2, candleWidth = 5, containerStyle = {}, waveColor, scrubColor, onPlayerStateChange, onRecorderStateChange, onPanStateChange, onError, onCurrentProgressChange, candleHeightScale = 3, onChangeWaveformLoadState, } = props;
    ...
    const { extractWaveformData, preparePlayer, getDuration, seekToPlayer, playPlayer, stopPlayer, pausePlayer, onCurrentDuration, onDidFinishPlayingAudio, onCurrentRecordingWaveformData, } = useAudioPlayer();
    ...
    return (React.createElement(View, { style: [styles.waveformContainer, containerStyle] },
        React.createElement(View, { ref: viewRef, style: styles.waveformInnerContainer, onLayout: () => {
